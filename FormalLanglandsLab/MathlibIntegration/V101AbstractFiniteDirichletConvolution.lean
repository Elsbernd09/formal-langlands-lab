...
def v101SwapSupport
    (support : List (Nat × Nat)) : List (Nat × Nat) :=
  support.map v101SwapPair
...
theorem v101_swap_pair_value
    (a b : Nat) :
    v101SwapPair (a, b) = (b, a) := by
  rfl

theorem v101_pair_contribution_swap
    (f g : v33ArithmeticFunction)
    (a b : Nat) :
    v101PairContribution f g (a, b) =
...
theorem v101_six_support_value :
    v101DivisorPairSupportSix =
      [(1, 6), (2, 3), (3, 2), (6, 1)] := by
  rfl

theorem v101_twelve_support_value :
    v101DivisorPairSupportTwelve =
      [(1, 12), (2, 6), (3, 4), (4, 3), (6, 2), (12, 1)] := by
  rfl
